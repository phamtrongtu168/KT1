...
import com.example.profiletest.fregment.ProFileFragment;
import com.google.android.material.bottomnavigation.BottomNavigationView;

public class Profile_main extends AppCompatActivity implements TruyenLegends
{
    ...
    public void DataLengends(CauThu cauThu) {
        Intent intent = new Intent(Profile_main.this, LengendsInfomation.class);
        intent.putExtra("thongtinlengends", (Parcelable) cauThu);
